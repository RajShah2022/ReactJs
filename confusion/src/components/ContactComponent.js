				...
				<div className="row row-content">
					...
					<div className="col-12 col-sm-11 offset-sm-1">
						<div className="btn-group" role="group">
							<p role="button" className="btn btn-primary" href="tel:+85212345678"><i className="fa fa-phone"></i> Call </p>
							<p role="button" className="btn btn-info" href="#"><i className="fa fa-skype" href="!#"></i> Skype </p>
							<p role="button" className="btn btn-success" href="mailto:confusion@food.net"><i className="fa fa-envelope-o"></i> Email</p>
						</div>
					</div>
				</div>
				<div className="row row-content">
						...
						<LocalForm model="feedback" onSubmit={(values) => this.handleSubmit(values)}>
							...
							<Row className="form-group">
								...
								<Col md={{size:3, offset:1}}>
									<Control.select model=".contactTypes" name="contactType" className="form-control" >
										<option>Tel.</option>
										<option>Email</option>
									</Control.select>
								</Col>
